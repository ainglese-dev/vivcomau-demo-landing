...
export function PrivacyPolicyContent() {
  return (
    <div className="space-y-6 text-sm text-foreground">
      ...
      <h3 className="text-black font-semibold">1. About This Policy</h3>
      <p>
      ...
      <h3 className="text-black font-semibold">2. Information We Collect</h3>
      ...
      <h3 className="text-black font-semibold">3. How We Use Your Information</h3>
      <ul className="list-disc pl-5 space-y-1">
      ...
      <h3 className="text-black font-semibold">4. Disclosure to Third Parties</h3>
      ...
      <h3 className="text-black font-semibold">6. Access & Correction</h3>
      <p>
      ...
      <h3 className="text-black font-semibold">7. Complaints</h3>
      <p>
      ...
      <h3 className="text-black font-semibold">8. Contact</h3>
      <p>
        VIVCOM PTY LTD<br />
